...
<style lang="scss">
	@import '@/common/semp.scss';
	view{
		font-size:$semp-font-size-small-s
	}
	.semp-city{
   ...
   .has-choose-box{
	...
	.has-choose{
		margin-right:50upx;
		border-bottom:2px solid $semp-bg-color-grey;
	}
	.has-choose.active{
		color:$semp-color-primary;
		border-color:$semp-color-primary;
	}
	#city-item-box{
		height:500upx;
	}
